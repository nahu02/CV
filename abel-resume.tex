...
\begin{rSection}{Education}
	...
	\begin{rSubsection}{Aarhus University}{Aug 2025 - Jul 2027 (exp.)}{Master of Science in Computer Science}{Aarhus, DK}
		\item Learning about human-computer interaction, and hardware- and software development in general
	\end{rSubsection}
...
\begin{rSection}{Personal Sideprojects}

	\begin{projSubsection}{Plice Missing Persons Database}{Stremlit App}{https://github.com/nahu02/missing-persons-utils}
		\item Web application for scraping and processing missing persons data from the Hungarian Police website
		\item Built for the National Institute of Criminology to aid their data acquisition and analysis of missing youths
	\end{projSubsection}
