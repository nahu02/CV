...
\begin{rSection}{Education}
	...
	\begin{rSubsection}{Aarhus University}{Aug 2025 - Jul 2027 (exp.)}{Master of Science in Computer Science}{Aarhus, DK}
		\item Learning about human-computer interaction, MR, and hardware- and software development in general
	\end{rSubsection}
	...
	\begin{rSubsection}{Budapest University of Technology and Economics}{Sep 2021 - Jan 2025}{Bachelor of Science in Computer Engineering}{Budapest, HU}
		\item Developed a strong foundation in Algorithms and Data Structures, Object-Oriented Programming, Declarative Programming, Software Engineering, Operating Systems, IT Security, AI, Mobile and Web Development
...
\begin{rSection}{Experience}
	...
	\begin{rSubsection}{Center For Hybrid Intelligence, Aarhus University}{Nov 2025 -}{IT Student Worker}{Aarhus, DK}
		\item Maintained and improved a web application used for long term cognitive studies with Vue.js and Neo4j
		\item Refactored and fixed bugs in a Quantum Computing data visualization dashboard using Stremlit
		\item Got used to working on various research projects, with technologies like Python, Stremlit, Vue and Node.js
	\end{rSubsection}
	...
	\begin{rSubsection}{Ifjusagi Nomad Klub}{Mar 2021 - Sep 2021}{Project Coordinator, Facilitator}{Budapest, HU}
		\item Coordinated 2 Youth Exchanges with 3 international partners and 10+ key stakeholders, arranging travel and accommodation for 114 participants over 23 days
...
\begin{rSection}{Personal and School Projects}
	...
	\begin{projSubsection}{EventSnap}{AI Android app}{https://github.com/nahu02/EventSnap2}
		\item Flutter Android app that uses OpenAI's API to process text, making it easy to add them to any calendar app
	\end{projSubsection}

	\begin{projSubsection2}{Homelab}{Ubuntu Server}
		\item Repurposed laptop into home server, tunneled through Cloudflare, hosting Immich and other services
	\end{projSubsection2}

	\begin{projSubsection}{CV Automatization}{CI/CD using GitHub Actions}{https://github.com/nahu02/CV}
...
\begin{rSection}{Technical Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Tools                   & Linux, Windows, Git, Slack, Visual Studio Code, Jupyter, PyCharm \\
	\end{tabular}
